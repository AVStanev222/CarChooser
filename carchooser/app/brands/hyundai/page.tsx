...
export default function HyundaiModelsPage() {
  return (
    <main className="min-h-screen bg-[#050214] text-white">
      <section className="max-w-6xl mx-auto px-6 pt-16 pb-12">
        ...
        <p className="text-gray-300 max-w-3xl mb-10">
          From city hatchbacks to EV crossovers and flagship SUVs, explore how
          Hyundai balances value, technology, and efficiency across its range.
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {hyundaiModels.map((model) => (
            <Link
              key={model.slug}
              href={`/brands/hyundai/${model.slug}`}
