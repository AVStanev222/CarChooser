  ...
  return (
    <main className="min-h-screen bg-[#050214] text-white">
      <section className="max-w-6xl mx-auto px-6 pt-16 pb-12">
        ...
        <SectionTitle>
          Tesla <span className="text-purple-400">Fleet</span>
        </SectionTitle>
        <p className="text-gray-300 max-w-3xl mb-10">
          Sedans, SUVs, pickups, and even the Semi—scroll through every Tesla we
          track before the Supabase live data layer arrives.
        </p>
