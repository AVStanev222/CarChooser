  ...
  return (
    <main className="min-h-screen bg-page text-text transition-colors">
      <section className="max-w-5xl mx-auto px-6 pt-16 pb-20">
        ...
        <CarActivityTracker
          carLabel={`Mitsubishi ${car.model} ${car.year}`}
          carPath={`/brands/mitsubishi/${car.slug}`}
        />

        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-12">
          <VehicleImageGallery brand="Mitsubishi" model={car.model} year={car.year} slug={car.slug} />
