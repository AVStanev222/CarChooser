  ...
  return (
    <main className="min-h-screen bg-[#050214] text-white">
      <section className="max-w-6xl mx-auto px-6 pt-16 pb-12">
        ...
        <SectionTitle>
          Audi <span className="text-purple-400">Model Range</span>
        </SectionTitle>
        <p className="text-gray-300 max-w-3xl mb-10">
          Premium hatchbacks, sedans, Avants, and SUVs—pick any Audi to see our
          curated specs, pricing, and placeholder gallery zones.
        </p>
