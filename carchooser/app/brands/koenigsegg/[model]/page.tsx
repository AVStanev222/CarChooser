  ...
  return (
    <main className="min-h-screen bg-[#050214] text-white">
      <section className="max-w-5xl mx-auto px-6 pt-16 pb-20">
        ...
        <CarActivityTracker
          carLabel={`Koenigsegg ${car.model} ${car.year}`}
          carPath={`/brands/koenigsegg/${car.slug}`}
        />

        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-12">
          <VehicleImageGallery brand="Koenigsegg" model={car.model} year={car.year} slug={car.slug} />
        ...
        <div className="bg-[#0d071d] border border-purple-500/20 rounded-2xl p-6 flex flex-col gap-4">
          <h3 className="text-xl font-semibold">Koenigsegg ownership notes</h3>
          <p className="text-gray-300 text-sm leading-relaxed">
            Once Supabase integration lands you will be able to upload real
            photos, keep service logs, and track market values for each chassis.
          </p>
        </div>
      </section>
    </main>
